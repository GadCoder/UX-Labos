	 	...
	 	<div class="row">                   
			...
			<div class="panel-body">                                              
				<div class="form-horizontal" role="form">    
						...
						<div class="col-lg-8">
							<select   name="cbocarrera" id="cbocarrera" class="form-control"  >
                                                            <option value="0">-Seleccionar Carrera-</option>
                                                              ...
                                                              <option value="">INGENIERIA DE  SISTEMAS</option>
						...
						<div class="col-lg-8">
							<input type="text"   name="txtcodigo" disabled="false" value="000001" class="form-control" >
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group text-center">						
						<button type="submit" class="btn btn-primary" onclick="" >
							<img src="../../imagenes/grabar.png"   width="20px" height="20px"  alt="Grabar"> Grabar
						</button>
                                                <button type="submit" class="btn btn-primary" onclick="" >
